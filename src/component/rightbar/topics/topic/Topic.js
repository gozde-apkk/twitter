...
import {numberFormat} from '../../../sidebar/utils/formats'
	...
	return (
		...
		>
			...
			<Popover className="absolute top-1.5 right-2">
				...
				<Popover.Panel className="w-[24rem] rounded-xl grid absolute top-2  right-0 bg-[color:var(--background-primary)] shadow-box z-[2]">
