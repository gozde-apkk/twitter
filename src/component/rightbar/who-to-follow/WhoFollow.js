...
import {whoFollowUsers} from '../../store/auth/followers'
        ...
        {whoFollowUsers.map((user , index) => (
            <button className='py-3 px-4 flex gap-3 transition-colors hover:bg-white/[0.03]'>
                ...
                <div className='flex-1 flex flex-col text-left'>
                    <div className='text-[15px] text-[#e7e9ea] items-center font-bold ' >
                        {user.fullname}
                        {user?.verified && (
                            <svg viewBox="0 0 22 22" width={18.75} height={18.75} className='text-[#1d9bf0] ml-0.5' ><g>
