...
import {useModal} from '../store/modal/hooks/hooks';
import { removeModal } from '../store/modal/actions/actions';
...
const currentModal = modals.find(m => m.name === modal.name)
    return (
        <div className='fixed inset-0 bg-[color:var[--background-modal]]/40 flex items-center justify-center z-20' >
