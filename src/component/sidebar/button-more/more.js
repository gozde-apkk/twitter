...
import {setModal} from  '../../store/modal/actions/actions'
...
function More() {
  return (
   <Popover className="relative ">
    ...
    <button className='px-4 h-14 w-full rounded-full transition-colors inline-flex items-center gap-5 hover:bg-[color:var(--background-secondary)]'>
        <div className='w-[26.25px]  h-[26.25px]  relative'>
               <svg viewBox="0 0 24 24" width={24} height={24} className='block'>
               <path fill='currentColor'd="M4 4.5C4 3.12 5.119 2 6.5 2h11C18.881 2 20 3.12 20 4.5v18.44l-8-5.71-8 5.71V4.5zM6.5 4c-.276 0-.5.22-.5.5v14.56l6-4.29 6 4.29V4.5c0-.28-.224-.5-.5-.5h-11z"></path></svg>
        </div>
     ...
     <button className='px-4 h-14 w-full rounded-full transition-colors inline-flex items-center gap-5 hover:bg-[color:var(--background-secondary)]'>
        <div className='w-[26.25px]  h-[26.25px]  relative'>
               <svg viewBox="0 0 24 24" width={24} height={24} className='block'>
               <path fill='currentColor' d="M23 3v14h-2V5H5V3h18zM10 17c1.1 0 2-1.34 2-3s-.9-3-2-3-2 1.34-2 3 .9 3 2 3zM1 7h18v14H1V7zm16 10c-1.1 0-2 .9-2 2h2v-2zm-2-8c0 1.1.9 2 2 2V9h-2zM3 11c1.1 0 2-.9 2-2H3v2zm0 4c2.21 0 4 1.79 4 4h6c0-2.21 1.79-4 4-4v-2c-2.21 0-4-1.79-4-4H7c0 2.21-1.79 4-4 4v2zm0 4h2c0-1.1-.9-2-2-2v2z"></path></svg>
        </div>
         <div className='pr-4 text-xl font-bold'>
              Para kazanma
        </div>
     ...
     <Disclosure>
      {( {open}) => (
         <>
           <Disclosure.Button className="h-[52px] flex justify-between w-full items-center px-4 font-bold transition-colors  hover:bg-[color:var(--background-secondary)]  " >
       ...
       <Disclosure.Panel>
              <Link to="/" className="flex items-center px-3 h-11 gap-3 text-[15px] transition-colors font-medium ">
                <svg viewBox="0 0 24 24" width={18.74} height={18.75}>
                <path fill='currentColor' d="M8.75 21V3h2v18h-2zM18 21V8.5h2V21h-2zM4 21l.004-10h2L6 21H4zm9.248 0v-7h2v7h-2z"></path></svg>
                İstatistik
              </Link>
       </Disclosure.Panel>
       </>
     ...
     {({open}) => (
      <>
        ...
        <Link to="/" className="flex items-center px-3 h-11 gap-3 text-[15px] font-medium ">
                 <svg viewBox="0 0 24 24" width={18.74} height={18.75}>
                 <path fill='currentColor' d="M1.996 5.5c0-1.38 1.119-2.5 2.5-2.5h15c1.38 0 2.5 1.12 2.5 2.5v13c0 1.38-1.12 2.5-2.5 2.5h-15c-1.381 0-2.5-1.12-2.5-2.5v-13zm2.5-.5c-.277 0-.5.22-.5.5v13c0 .28.223.5.5.5h15c.276 0 .5-.22.5-.5v-13c0-.28-.224-.5-.5-.5h-15zm8.085 5H8.996V8h7v7h-2v-3.59l-5.293 5.3-1.415-1.42L12.581 10z"></path></svg>
                 Reklamlar
               </Link>
     ...
     <Disclosure>
        {({open}) => (
         <>
<Disclosure.Button className="h-[52px] flex justify-between w-full items-center p-4 font-bold transition-colors  hover:bg-[color:var(--background-secondary)]  " >
          Ayarlar ve Destek
        ...
        <button onClick= {() => setModal('appearance')} className="flex items-center w-full px-3 h-11 gap-3 text-[15px]font-medium hover:bg-[color:var(--background-secondary)]transition-colors ">
                 <svg viewBox="0 0 24 24" width={18.74} height={18.75}>
